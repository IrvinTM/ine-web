function lineaRecta(costoInicial: number, valorResidual: number, vidaUtil: number): number[] {
...
function saldoDecreciente(costoInicial: number, valorResidual: number, vidaUtil: number): number[] {
...
function sumaDigitos(costoInicial: number, valorResidual: number, vidaUtil: number): number[] {
...
function unidadProduccion(costoInicial: number, valorResidual: number, unidadesAnuales: number[], unidadesTotales: number): number[] {
...
function seleccionOptima(metodos: { [key: string]: number[] }, criterio: string): [string, number[]] {
